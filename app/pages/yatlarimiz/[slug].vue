  ...
  <main class="w-full bg-[#FAFAFA] min-h-screen font-sans selection:bg-[#0C2340] selection:text-white pb-24">
    ...
    <section class="bg-[#0C2340] pt-32 pb-16 relative">
      ...
      <div v-if="yacht" class="max-w-[1300px] mx-auto px-6 lg:px-8">
        <div class="flex flex-col lg:flex-row gap-4 h-[35vh] md:h-[50vh] lg:h-[65vh] min-h-[300px] md:min-h-[450px] max-h-[700px]">
          <!-- Ana Görsel (Sol) -->
          <div class="w-full lg:w-[65%] h-full relative group rounded-[20px] overflow-hidden bg-black shadow-lg">
            ...
            <button @click.stop="openLightbox(0)" class="hidden md:flex absolute bottom-5 right-5 bg-white/90 backdrop-blur-md text-[#0C2340] font-bold text-[14px] px-6 py-2.5 rounded-full items-center gap-2 hover:bg-white hover:scale-105 transition-all shadow-xl z-10">
